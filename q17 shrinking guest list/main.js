...
var guestlist = ["Anis", "Sheryar", "Habib", "Osama", "Yasir", "Waqas",];
...
guestlist.forEach(function (guests) { return console.log("Hello, ".concat(guests, " would you like to come dinner with me")); });
...
guestlist.forEach(function (lasttwoguests) { return console.log("Luckly, ".concat(lasttwoguests, " you are still invited to dinner")); });
